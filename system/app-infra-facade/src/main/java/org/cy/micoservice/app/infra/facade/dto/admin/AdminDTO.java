package org.cy.micoservice.app.infra.facade.dto.admin;
...
import org.cy.micoservice.app.entity.infra.console.model.req.sys.admin.AdminRegisterReq;
import org.cy.micoservice.app.entity.infra.console.model.req.sys.admin.AdminSaveReq;
...
public class AdminDTO {
  ...
  public static SysAdmin convertSaveAdminReq(AdminRegisterReq baseReq) {
    ...
    LocalDateTime nowDateTime = DateUtil.localDateTimeNow();
  ...
  public static SysAdmin convertAddUserReq(AdminSaveReq req) {
    ...
    build.setCreateId(req.getAdminId());
    build.setUpdateId(req.getAdminId());
  ...
  public static SysAdmin convertEditUserReq(SysAdmin before, AdminSaveReq req) {
   ...
   before.setUpdateId(req.getAdminId());
