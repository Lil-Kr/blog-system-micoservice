...
import org.cy.micoservice.blog.entity.admin.model.entity.sys.*;
...
import static org.cy.micoservice.blog.admin.provider.common.constants.CommonConstants.ACLM_PREV_INFO;
...
public class SysAclServiceImpl extends ServiceImpl<SysAclMapper, SysAcl> implements SysAclService {
  ...
  public ApiResp<String> add(AclReq req) {
    ...
    // 更新缓存
    rbacCacheService.invalidAllAdminAclCache();
