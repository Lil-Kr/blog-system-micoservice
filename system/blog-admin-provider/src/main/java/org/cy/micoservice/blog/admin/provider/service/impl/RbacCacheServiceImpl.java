...
import static org.cy.micoservice.blog.admin.provider.common.constants.CommonConstants.*;
...
public class RbacCacheServiceImpl implements RbacCacheService, Serializable {
	...
	@Override
	public void setAdminIdCache(Long id, SysAdmin user) {
	...
	@Override
	public void removeAdminIdCache(Long id) {
