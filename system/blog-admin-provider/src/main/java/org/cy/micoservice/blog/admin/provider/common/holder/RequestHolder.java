// package org.cy.micoservice.blog.admin.provider.common.holder;
//
...
//    * 每个用户登录进来都会分别存放用户信息
//    */
//   private static final ThreadLocal<SysAdmin> userHolder = new ThreadLocal<>();
//
//   /**
//    * 存放线程隔离的http请求信息
//    */
...
//    * @param user
//    */
//   public static void setCurrentUser(SysAdmin user){
//     userHolder.set(user);
//   }
//
//   /**
