...
import org.cy.micoservice.blog.im.facade.router.connector.dto.body.ImLogoutBody;
...
public class ImLogoutMsgMqConsumer implements InitializingBean {
  ...
  private void initLogoutMqConsumer() throws MQClientException {
    ...
    mqPushConsumer.setConsumerGroup(rocketMQConsumerProperties.getGroup() + "_" + ImLogoutMsgMqConsumer.class.getSimpleName());
