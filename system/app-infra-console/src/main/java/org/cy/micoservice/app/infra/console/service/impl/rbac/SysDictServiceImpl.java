...
import org.cy.micoservice.app.entity.infra.console.model.req.sys.dict.DictDetailReq;
import org.cy.micoservice.app.entity.infra.console.model.req.sys.dict.DictListPageReq;
import org.cy.micoservice.app.entity.infra.console.model.req.sys.dict.DictSaveReq;
...
import org.cy.micoservice.app.infra.console.dao.rbac.SysDictDetailMapper;
import org.cy.micoservice.app.infra.console.dao.rbac.SysDictMapper;
import org.cy.micoservice.app.infra.console.service.RbacCacheService;
...
public class SysDictServiceImpl extends ServiceImpl<SysDictMapper, SysDict> implements SysDictService {
	...
	public ApiResp<String> add(DictSaveReq req) {
		...
		if (insert >= 1) {
			rbacCacheService.updateDictCache(dict.getSurrogateId(), dict, CommonConstants.BUS_CREATE);
	...
	public ApiResp<String> edit(DictSaveReq req) {
		...
		try {
			...
			if (update >= 1) {
				rbacCacheService.updateDictCache(after.getSurrogateId(), after, CommonConstants.BUS_EDIT);
