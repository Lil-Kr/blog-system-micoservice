package org.cy.micoservice.blog.framework.id.starter.autoconfigure;

import org.cy.micoservice.blog.framework.id.starter.core.SimpleRedisWorkerIdAllocator;
import org.cy.micoservice.blog.framework.id.starter.core.SnowflakeIdGenerator;
import org.cy.micoservice.blog.framework.id.starter.core.WorkerIdAllocator;
import org.cy.micoservice.blog.framework.id.starter.monitor.DefaultIdObservationService;
import org.cy.micoservice.blog.framework.id.starter.monitor.IdMonitor;
import org.cy.micoservice.blog.framework.id.starter.monitor.IdObservationService;
import org.cy.micoservice.blog.framework.id.starter.monitor.NoOpIdMonitor;
import org.cy.micoservice.blog.framework.id.starter.monitor.RedisIdMonitor;
import org.cy.micoservice.blog.framework.id.starter.service.DefaultIdService;
...
@ConditionalOnProperty(prefix = "blog.id", name = "enabled", havingValue = "true", matchIfMissing = true)
